...
export const leafNodeNames = new Set(['BR', 'HR', 'IFRAME', 'IMG', 'INPUT']);
...
export const resetNodeCategoryCache = (): void => {
    cache = new WeakMap();
};
...
export const getNodeCategory = (node: Node): number => {
...
export const isInline = (node: Node): boolean => {
...
export const isContainer = (node: Node): boolean => {
